...
#region Save UI
if (__save_state == SAVE_STATE.CHOOSING || __save_state == SAVE_STATE.FINISHED)
{
	__wait_time++;
...
if (__menu_ui_x > -140)
{
	...
	#region Drawing the box for each state
		#region ITEM state
		if (__menu_ui_y[MENU_MODE.ITEM] > -500)
		{
			var ui_box_y = __menu_ui_y[MENU_MODE.ITEM] + 6;
			// Box Drawing
		...
		#endregion
		#region STAT state
		if (__menu_ui_y[MENU_MODE.STAT] > -480)
		{
			var ui_box_y = __menu_ui_y[MENU_MODE.STAT] + 6;
		...
		#endregion
		#region CELL state
		if (__menu_ui_y[MENU_MODE.CELL] > -500)
		{
			var ui_box_y = __menu_ui_y[MENU_MODE.CELL] + 6;
