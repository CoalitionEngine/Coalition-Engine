...
if encounter_draw & 1 draw_clear(c_black);
if encounter_draw & 2 draw_sprite_ext(sprite_index, image_index,
...
if encounter_draw & 4 draw_sprite_ext(sprSoul, 0, encounter_soul_x, encounter_soul_y, 1, 1, 0, c_red, 1);