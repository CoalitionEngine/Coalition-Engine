...
**Methods**
---
### `.__DefaultAttackFormula()` 
Returns: `undefined`

The default formula for player attack calculation

### `.__DefaultDefenseFormula()` 
Returns: `undefined`

The default formula for player defense calculation

### `.SetAttackFormula(formula)` 
Returns: `Struct.__Player`

Sets the formula for player attack calculation

| Parameter | Datatype  | Purpose |
|-----------|-----------|---------|
|`formula` |`Function` |The function of the formula (Default Undertale's formula) |

### `.SetDefenseFormula(formula)` 
Returns: `Struct.__Player`

Sets the formula for player defense calculation
...
Sets/Gets the invincibility frames of the player

| Parameter | Datatype  | Purpose |
|-----------|-----------|---------|
|`inv` |`Real` |The invincibility frames to set (If needed) |
