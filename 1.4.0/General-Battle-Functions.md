...
Defines a button for the battle menu

| Parameter | Datatype  | Purpose |
|-----------|-----------|---------|
|`button` |`Real` |The button to define |
|`state` |`Real` |The state the battle will go to when the button is selected |
|`sprite` |`Assets.GMSprite` |The sprite of the button |
|`x` |`Real` |The x coordinate of the button |
|`y` |`Real` |The y coordinate of the button |
|`soul_x` |`Real` |The x coordinate of the soul relative to the button |
|`soul_y` |`Real` |The y coordinate of the soul relative to the button |
|`Scales` |`Array<real>` |The scales of the button ([Unselected scale, Selected scale]) |
|`Alphas` |`Array<real>` |The alphas of the button ([Unselected alpha, Selected alpha]) |
|`Colors` |`Array<real>` |The colors of the button ([Unselected color, Selected color]) |
|`EnableCondition` |`Function` |The condition of the availability of the button (Default always true) |
|`Step` |`Function` |The processing logic of the button (Default empty function) |
|`Draw` |`Function` |The drawing logic of the button (Default empty function) |
...
### `.Button(index, button)` 
Returns: `e`, button struct

Sets the index of the button or Get the button from index

| Parameter | Datatype  | Purpose |
|-----------|-----------|---------|
|`index` |`Real` |The index to set the button to |
|`button` |`Real` |The button to set (Set to empty for reading) |
