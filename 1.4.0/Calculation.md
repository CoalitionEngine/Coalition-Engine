...
Sets the value of the specified index of the bit to 1

| Parameter | Datatype  | Purpose |
|-----------|-----------|---------|
|`bit` |`Real` |The bit to edit |
|`index` |`Real` |The index to change |
...
Sets the value of the specified index of the bit to 0
...
### `toggle_bit(bit, index)`
---
 Returns: `undefined`

Toggles the value of the specified index of the bit
...
Reads the value of the specified index of the bit
